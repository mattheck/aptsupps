...
<?php if ( $order->has_status( 'pending' ) ) : ?>
	...
	<p><?php printf( __( 'An order has been created for you on %s. If we can be of further service, please contact us at info@aptsupps.com or 1-800-609-2709. To pay for this order please use the following link: %s', 'woocommerce' ), get_bloginfo( 'name', 'display' ), '<a href="' . esc_url( $order->get_checkout_payment_url() ) . '">' . __( 'pay', 'woocommerce' ) . '</a>' ); ?></p>
