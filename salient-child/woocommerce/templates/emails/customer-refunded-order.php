...
<p><?php
	if ( $partial_refund ) {
		printf( __( "Hi there. Your order on %s has been partially refunded. If we can be of further service, please contact us at info@aptsupps.com or 1-800-609-2709. ", 'woocommerce' ), get_option( 'blogname' ) );
	}
	else {
