...
function nectar_register_js() {	
	...
	if (!is_admin()) { 
		...
		wp_register_script('nectar_prettyPhoto', get_template_directory_uri() . '/js/prettyPhoto.js', 'jquery', '5.5.3', TRUE);
		...
		wp_register_script('nectarSlider', get_template_directory_uri() . '/js/nectar-slider.js', 'jquery', '5.5.3', TRUE);
		wp_register_script('iosSlider', get_template_directory_uri() . '/js/jquery.iosslider.min.js', 'jquery', '5.5.3', TRUE);
		wp_register_script('ajaxify', get_template_directory_uri() . '/js/ajaxify.js', 'jquery', '5.5.3', TRUE);

		if ( floatval(get_bloginfo('version')) < "3.6" ) {
			wp_register_script('jplayer', get_template_directory_uri() . '/js/jplayer.min.js', 'jquery', '2.1', TRUE);
		}
		wp_register_script('nectarFrontend', get_template_directory_uri() . '/js/init.js', array('jquery', 'superfish'), '5.5.3', TRUE);
...
function nectar_main_styles() {	
		 ...
		 // Register 
		 wp_register_style('rgs', get_template_directory_uri() . '/css/rgs.css', '', '5.5.3');
		 wp_register_style('orbit', get_template_directory_uri() . '/css/orbit.css');
		 wp_register_style('woocommerce', get_template_directory_uri() . '/css/woocommerce.css');
		 wp_register_style('font-awesome', get_template_directory_uri() . '/css/font-awesome.min.css');
		 wp_register_style("main-styles", get_stylesheet_directory_uri() . "/style.css", '', '5.5.3');
		 wp_register_style("responsive", get_template_directory_uri() . "/css/responsive.css", '', '5.5.3');
		 wp_register_style("non-responsive", get_template_directory_uri() . "/css/non-responsive.css");
		 wp_register_style("skin-ascend", get_template_directory_uri() . "/css/ascend.css", '', '5.5.3');
							...
							<div id="portfolio-nav">
								...
								<ul class="controls">                                       
									...
									if(!empty($options['portfolio_same_category_single_nav']) && $options['portfolio_same_category_single_nav'] == '1') { ?>
											<li id="prev-link"><?php be_next_post_link('%link','<i class="icon-salient-left-arrow-thin"></i>'); ?></li>
											<li id="next-link"><?php be_previous_post_link('%link','<i class="icon-salient-right-arrow-thin"></i>'); ?></li> 
										<?php } else { ?>
...
function woocommerce_output_related_products() {
	...
	$product_extra_description = get_field('product_extra_description');
	$product_title = get_field('title');
	
	if($product_extra_description != '')
	{
		echo '<div class="extra_description">
		<h2>'.$product_title.'</h2>
